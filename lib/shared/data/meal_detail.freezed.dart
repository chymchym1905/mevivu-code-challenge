...
mixin _$MealDetail {
  ...
  String? get strMealAlternate => throw _privateConstructorUsedError;
...
abstract class $MealDetailCopyWith<$Res> {
  factory $MealDetailCopyWith(
      ...
      _$MealDetailCopyWithImpl<$Res, MealDetail>;
  @useResult
  $Res call(
      {String? idMeal,
      String? strMeal,
...
/// @nodoc
class _$MealDetailCopyWithImpl<$Res, $Val extends MealDetail>
  ...
  $Res call({
    ...
    Object? strMealAlternate = freezed,
    ...
    return _then(_value.copyWith(
      ...
      strMeal: freezed == strMeal
          ...
          : strMeal // ignore: cast_nullable_to_non_nullable
              as String?,
      strMealAlternate: freezed == strMealAlternate
          ? _value.strMealAlternate
          : strMealAlternate // ignore: cast_nullable_to_non_nullable
              as String?,
...
/// @nodoc
abstract class _$$MealDetailImplCopyWith<$Res>
    implements $MealDetailCopyWith<$Res> {
  factory _$$MealDetailImplCopyWith(
          _$MealDetailImpl value, $Res Function(_$MealDetailImpl) then) =
      __$$MealDetailImplCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {String? idMeal,
...
/// @nodoc
class __$$MealDetailImplCopyWithImpl<$Res>
    extends _$MealDetailCopyWithImpl<$Res, _$MealDetailImpl>
    implements _$$MealDetailImplCopyWith<$Res> {
  __$$MealDetailImplCopyWithImpl(
      _$MealDetailImpl _value, $Res Function(_$MealDetailImpl) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$MealDetailImpl implements _MealDetail {
  const _$MealDetailImpl(
      {this.idMeal,
      this.strMeal,
  ...
  factory _$MealDetailImpl.fromJson(Map<String, dynamic> json) =>
      _$$MealDetailImplFromJson(json);
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is _$MealDetailImpl &&
            (identical(other.idMeal, idMeal) || other.idMeal == idMeal) &&
            (identical(other.strMeal, strMeal) || other.strMeal == strMeal) &&
            (identical(other.strMealAlternate, strMealAlternate) ||
                other.strMealAlternate == strMealAlternate) &&
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$MealDetailImplCopyWith<_$MealDetailImpl> get copyWith =>
      __$$MealDetailImplCopyWithImpl<_$MealDetailImpl>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$MealDetailImplToJson(
      this,
    );
  }
}
...
abstract class _MealDetail implements MealDetail {
  const factory _MealDetail(
      ...
      final String? strImageSource,
      final String? strCreativeCommonsConfirmed,
      final String? dateModified}) = _$MealDetailImpl;

  factory _MealDetail.fromJson(Map<String, dynamic> json) =
      _$MealDetailImpl.fromJson;
